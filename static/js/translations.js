...
const TRANSLATIONS = {
    ru: {
        ...
        'login.via_google': 'Войти через Google',
        'auth.google_only': 'Вы авторизованы через Google. Для доступа к спискам и обзору войдите через Shikimori.',
        'auth.not_authorized': 'Авторизация не выполнена',
        'auth.not_authorized.desc': 'Войдите через Shikimori или Google, чтобы просмотреть свой профиль, списки и обзор.',
        ...
        'settings.google_account': 'Google аккаунт',
        'settings.google.link_hint': 'Привяжите Google аккаунт для входа через Google.',
        'settings.google.add': 'Добавить аккаунт Google',
        'settings.google.linked': 'Google аккаунт привязан:',
        'settings.google.unlink': 'Отвязать аккаунт Google',
        'settings.google.unlink_confirm': 'Вы уверены, что хотите отвязать Google аккаунт?',
        'settings.google.unlink_error': 'Не удалось отвязать Google аккаунт',
        'settings.google.unlink_error_detail': 'Произошла ошибка при отвязке Google аккаунта',
    ...
    en: {
        ...
        'login.via_google': 'Log in with Google',
        'auth.google_only': 'You are authorized via Google. To access lists and explore, log in with Shikimori.',
        'auth.not_authorized': 'Authorization not completed',
        'auth.not_authorized.desc': 'Log in with Shikimori or Google to view your profile, lists and explore.',
        ...
        'settings.google.link_hint': 'Link a Google account to sign in with Google.',
        'settings.google.add': 'Add Google account',
        'settings.google.linked': 'Google account linked:',
        'settings.google.unlink': 'Unlink Google account',
        'settings.google.unlink_confirm': 'Are you sure you want to unlink your Google account?',
        'settings.google.unlink_error': 'Failed to unlink Google account',
        'settings.google.unlink_error_detail': 'An error occurred while unlinking your Google account',
